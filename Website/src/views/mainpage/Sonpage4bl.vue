    ...
    <el-divider/>
      ...
      <el-main class="main1">
        <div style="display: flex; flex-direction: column;justify-content: flex-start;">
            <div style="display: flex;margin-left: 10%;margin-top: 0px;margin-bottom: -10px;align-items: baseline;">
            <span style="font-weight: bold;font-size: 35px;font-family: '方正字迹-惊鸿体',sans-serif;margin-top: -6px;margin-right: 0.5%;">Block</span>
            <span style="font-size: 30px;margin-left: 10px;color: #b5b6ba;">#{{ PSingStore.blockinf.blocknumber }}</span>
        </div>
