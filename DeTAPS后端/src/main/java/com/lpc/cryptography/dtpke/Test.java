...
import com.lpc.cryptography.base.SM4;
...
public class Test implements PairingProvider {
    public static void main(String[] args) throws Exception {
        ...
        T[3]=S[7];
        T[4]=S[9];
        List<Element> ATSsignature = new ArrayList<>();

        ATSsignature.add(g);

        SecretKey AESkey = new SecretKeySpec(Hash.calculateSM3Hash(T[0].toBytes()), "AES");
        ...
        List<Object> dtpkeEncrypt2= dtpke.Encrypt(EK, S, t, ATSsignature);
        long l18 = System.currentTimeMillis();
        long l19=l18-l17;
        System.out.println("Encrypt2用时为： "+l19+"ms");
